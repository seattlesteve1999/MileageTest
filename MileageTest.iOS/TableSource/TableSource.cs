...
{
    public partial class MyTableSource : UITableViewSource
    {

        private readonly string cellID = "MyCell";
        private MyCell cell;
        ...
        public MyTableSource(List<Mileage> mileageInfo, UIViewController ctl)
        {
            dataList = mileageInfo;
        }

        public MyTableSource(List<Mileage> mileageInfo)
        {
            dataList = mileageInfo;
        }
        ...
        public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
        {
            ...
            cell = tableView.DequeueReusableCell(cellID) as MyCell;
            ...
            {
                cell.SetData(null, null, null, null, 0, null, null);
            ...
            else
            {
                ...
                string note = dataList[row].Note;

                cell.SetData(dataList[row].Date.ToString("MM/dd/yy"), milesRound.ToString(), gasRound.ToString(), mpgRound.ToString(), dataList[row].Id, costRound.ToString(), note);
            }
        ...
        public override UIView GetViewForHeader(UITableView tableView, nint section)
        {
            ...
            UILabel label = new UILabel
            {
                ...
                Frame = new RectangleF(12, 62, 370, 23),
                Text = "View Mileage",
            ...
            UIButton buttonMpg = new UIButton
            {
                ...
                BackgroundColor = UIColor.DarkGray,
                Font = UIFont.FromName("Helvetica-Bold", 13f),
                Frame = new CGRect(250, 105, 50, 25)
            };
            ...
            UIButton buttonCost = new UIButton
            {
                ...
                BackgroundColor = UIColor.DarkGray,
                Font = UIFont.FromName("Helvetica-Bold", 13f),
                Frame = new CGRect(320, 105, 50, 25)
            };
        ...
        public class MyCell : UITableViewCell
        {
            ...
            public void SetData(string str0, string str1, string str2, string str3, int id, string str4, string str5)
            {
                lbC4.Text = "";
                lbC0.Text = str0;
                lbC1.Text = str1;
            ...
            {
                nfloat lbWidth = Bounds.Width / 7;
                nfloat lbWidth2 = lbWidth - 50;
                nfloat lbWidth3 = lbWidth2 + 85;
                nfloat lbWidth4 = lbWidth3 + 70;
                nfloat lbWidth5 = lbWidth4 + 85;
                nfloat lbWidth6 = lbWidth5 + 75;
                nfloat lbHeight = this.Bounds.Height - 100;
                if (lbC0 != null)
                {
                    lbC4.Frame = new CGRect(2, 55, lbWidth, lbHeight);
                    lbC0.Frame = new CGRect(lbWidth2, 55, 80, lbHeight);
                    lbC1.Frame = new CGRect(lbWidth3, 55, lbWidth, lbHeight);
                    lbC2.Frame = new CGRect(lbWidth4, 55, lbWidth, lbHeight);
                    lbC3.Frame = new CGRect(lbWidth5, 55, 60, lbHeight);
                    lbcst.Frame = new CGRect(lbWidth6, 55, lbWidth, lbHeight);
                }
            }
        }
    }
